...
import CuaHangNoiThat.Entity.Users;
import CuaHangNoiThat.Service.User.BillsServiceImpl;
import CuaHangNoiThat.Service.User.CartServiceImpl;
...
public class CartController extends BaseController{
	...
	public ModelAndView Indexx() {
		...
		_mvShare.addObject("categorys", _homeService.GetDataCategorys());
		_mvShare.addObject("products", _homeService.GetDataProducts());
		_mvShare.setViewName("user/bills/thanhcong");
		return _mvShare;
	}
